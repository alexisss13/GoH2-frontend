...
function RegisterComponent() {
  ...
  const onSubmit = async (data: RegisterFormData) => {
    ...
    // Ejecutamos registro y esperamos true/false
    ...
    <div className="relative min-h-screen bg-black text-white overflow-hidden">
      ...
      <div className="flex flex-col lg:flex-row min-h-screen items-center justify-center px-4 sm:px-6 md:px-8 pt-48 sm:pt-52 lg:pt-32 pb-12 sm:pb-16 lg:pb-24 gap-3 sm:gap-4 lg:gap-12 max-w-7xl mx-auto">
        ...
        <div className="flex-1 flex flex-col items-center justify-center w-full animate-scale-in">
          <div className="relative w-28 h-28 sm:w-36 sm:h-36 lg:w-56 lg:h-56 xl:w-72 xl:h-72">
            <Oso />
        ...
        <div className="flex-1 flex flex-col items-center lg:items-start justify-center w-full animate-fade-in">
          <div className="w-full max-w-md">
            
            {/* Título del Formulario */}
            <div className="mb-3 sm:mb-4 lg:mb-6">
              <h1 className="text-xl sm:text-2xl lg:text-3xl xl:text-4xl font-bold text-white mb-1 text-center lg:text-left">
                {t('registerTitle')}
              </h1>
            </div>
            
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-2 sm:space-y-2.5 lg:space-y-3.5">
              ...
              <div className="animate-fade-in-delayed">
                <Button type="submit" variant="primary" isLoading={isLoading} className="mt-2 sm:mt-3 lg:mt-5 w-full">
                  {t('registerButton')}
                </Button>
              </div>

              {/* Link a login */}
              <div className="text-center pt-2 sm:pt-3 lg:pt-4 text-xs sm:text-sm lg:text-base text-gray-light animate-fade-in-delayed">
